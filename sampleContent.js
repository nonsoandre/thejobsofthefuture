...
Character.AI, founded by veterans of Google’s DeepMind project, has gained popularity for its unique chatbots. These AI-driven chatbots are designed to mimic historical personalities and famous fictional characters, particularly resonating with the 18 to 24-year-old demographic. Earlier this year, Character.AI raised a significant $150 million, and now, with Google's potential investment, the startup's valuation could soar to $5 billion.

 

The Synergy Between Google and Character.AI

The relationship between Google and Character.AI isn't new. It began in May 2023 when Google helped set up the startup's core infrastructure. Character.AI already leverages Google’s cloud services and tensor processing units for its AI training operations. The use of Google Cloud Spanner has notably enhanced the startup's performance capabilities, reaching several petaflops.
